...
namespace Accessories.Models
{
    public class Attributes
    {
        ...
        public void AttChange(ref List<Two> listAttributes, int id_)
        {
            ...
            using (MySql.Data.MySqlClient.MySqlDataReader reader = command.ExecuteReader())
            {
                while (reader.Read())
                {
                    ...
                    listAttributes.Add(new Two(id, name));
        ...
        public void Delete(int category_id)
        {
            ...
            string sql = @"DELETE FROM ATTRIBUTES WHERE id = " + category_id;
